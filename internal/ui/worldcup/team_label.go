...
//  1. A WC-local Name → code override map for known mismatches where FotMob
//     ships the full English name without a populated short code
//     (e.g. "Netherlands" → "NED") or ships an ambiguous short code.
//  2. team.ShortName as-is when the override map has no match.
//  3. A deterministic fallback: uppercase the first 3 letters of the name
